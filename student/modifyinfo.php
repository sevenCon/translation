...
<script type="text/javascript" src="../js/s_changestupwd.js"></script>
</head>
...
<p text-align="left" style="border-bottom:2px solid rgb(202, 214, 226);"><font size="+3">学生密码修改</font></p>
		<table border="0" width="350" height="90" style="margin-top:30px;">
			...
			<tr align="center" height="40">
				<td colspan="2">			
					...
					<div>		
						<input class="button_style"style="margin-left:10px;" id="submit" type="button" value="提交"  onclick="submit('<?php echo $studentId;?>')"/>
