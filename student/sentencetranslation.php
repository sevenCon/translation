...
<input type='button' value='导出已完成题目Excel' class='btn btn-success' onclick=\"location.href="."'outputExcel.php?flag=yuehan'"."\"/>
<br/>
</h1>";
...
echo  "<div class='questionRightTop'></div>";
echo  "<div class='questionBottom'><h1>可做的题目<br />
</h1>";
echo  "<div class='questionInner'>";
