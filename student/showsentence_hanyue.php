...
require "../functionfile/config.inc.php";
 ...
 $sql= "select * from questions_hanyue where question_hanyue_id='". $_SESSION['str'.$id]."'";//title-id

  $result=mysql_query($sql);
  while($result_set=mysql_fetch_array($result))
  {
	$re=$result_set['question_text']  ;
	$qid=$result_set['question_hanyue_id'];
	...
	echo  "题目：<br />";
	echo  $re."<br/>";
	echo   "<FORM METHOD=POST ACTION='score_hanyue.php' onSubmit='return checkForm()'> " ;
	echo "<br/>";
